...
% Upload arrow now goes UP from unimpeded to zenodo
\draw [arrow] ([xshift=-1.5cm]unimpeded.north) -- node[midway, left, font=\small] {Upload} (left-arrow);
% Download arrow now goes DOWN from zenodo to unimpeded
\draw [arrow] (right-arrow) -- node[midway, right, font=\small] {Download} ([xshift=1.5cm]unimpeded.north);
