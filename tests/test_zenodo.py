...
def test_depositions():
    ...
    r = z.depositions.create(title=title, description=description, creators=creators)
    time.sleep(1)
    ...
    z.depositionfiles(r["id"]).create(f"file2 on {dt}", datafile_2, new_api=False)
