...
htmlhelp_basename = 'unimpededdoc'
...
latex_documents = [
    (master_doc, 'unimpeded.tex', 'unimpeded Documentation',
     'Will Handley', 'manual'),
]
...
man_pages = [
    (master_doc, 'unimpeded', 'unimpeded Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'unimpeded', 'unimpeded Documentation',
     author, 'unimpeded', 'Universal model comparison & parameter estimation distributed over every dataset.',
     'Miscellaneous'),
]
